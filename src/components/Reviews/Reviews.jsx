...
export const Reviews = () => {
  ...
  return (
    <ListReviews>
      {reviews.length === 0 ? <p>We don`t have any information about cast for this movie</p>
        : reviews.map(el => (
         <ListItem alignItems="flex-start">
        <ListItemAvatar>
        <Avatar alt={`${el.author}` } src={`https://image.tmdb.org/t/p/w200/${el.author_details.avatar_path}`} />
      </ListItemAvatar>
          <ListItemText
        primary={`${el.author}` }
          secondary={
